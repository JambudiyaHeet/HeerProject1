...
if(isset($_GET['id']) && $_GET['id']!=''){
	...
	if ($res && mysqli_num_rows($res) > 0) {
		...
		die("Error: No rows found or query failed.");
	    }
...
if(isset($_POST['submit'])){
	...
	$query=("select * from coupon_master where coupon_code='$coupon_code'");
	$query = "SELECT * FROM coupon_master WHERE coupon_code='$coupon_code'"; // Fix column name

                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="footer">
                                ...
                                <div class="ft__details">
                                    <p>The Spinster, originating from Delhi, is now delivering high-quality vintage vinyl records across India and abroad, bringing the magic of music to collectors worldwide. 🎶✨</p>
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12 xmt-40">
                            <div class="footer">
                                ...
                                <div class="ft__inner">
                                    <ul class="ft__list">
                                        <li><a href="our_journey.php">About us</a></li>
                                        <li><a href="my_order_details.php">Delivery Information</a></li>
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12 xmt-40 smt-40">
                            <div class="footer">
                                ...
                                <div class="ft__inner">
                                    <ul class="ft__list">
                                        <li><a href="categories.php?id=5">Genres</a></li>
                                        <li><a href="cart.php">My Cart</a></li>
                                        <li><a href="login.php">Login</a></li>
                                        <li><a href="wishlist.php">Wishlist</a></li>

						...
						<div class="htc__grid__top">
							<div class="htc__select__option">
								<select class="ht__select"
									...
									<option value="price_low" <?php echo $price_low_selected ?>>Sort by price low to high
									</option>
							...
							<div class="shop__grid__view__wrap">
								<div role="tabpanel" id="grid-view"
									...
									foreach ($get_product as $list) {
										if ($counter % 4 == 0) { // Start a new row after every 4 products
											echo '<div class="row">';
										}
										?>
										...
										<?php
										$counter++;
										if ($counter % 4 == 0) { // Close the row after 4 products
											echo '</div>';
										}
									}
									// If the last row doesn't have exactly 4 products, close it manually.
									if ($counter % 4 != 0) {
										echo '</div>';
									}
									?>
